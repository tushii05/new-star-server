                                        ...
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                <div class="alert alert-success" role="alert" style="font-size: 15px;">
                                                    If you don't have a <b>license code</b>, please go to our help desk and generate your license code. You can easily manage your licenses through this system and you can contact us by opening a ticket for any problems.
                                                    <br><br>
                                                    If you see "Invalid License Code" error, please read this article:&nbsp;<a href="https://codingest.net/knowledge-base?content=129" target="_blank"><strong>Invalid License Code</strong></a>
                                                </div>
                                            </div>
                                            <div class="form-group text-center">
                                                <a href="https://codingest.net/" target="_blank" class="btn btn-success btn-custom">Go to Help Desk</a>
                                            </div>
                                            <div class="form-group text-center">
