...
class ProfileController extends BaseController
{
    ...
    public function profile($slug)
    {
        ...
        $data['posts'] = getCachedData($postsKey . '_page' . $data['pager']->currentPage);
        if (empty($data['posts'])) {
            $data['posts'] = $postModel->getUserPostsPaginated($data['user']->id, $this->generalSettings->pagination_per_page, $data['pager']->offset);
            setCacheData($postsKey . '_page' . $data['pager']->currentPage, $data['posts']);
        }
