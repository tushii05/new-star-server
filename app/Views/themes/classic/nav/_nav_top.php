...
<li class="top-li-auth"><a href="#" data-toggle="modal" data-target="#modalLogin" class="btn_open_login_modal"><?= trans("login"); ?></a><span>&nbsp;/&nbsp;</span><a href="<?= generateURL('register'); ?>"><?= trans("register"); ?></a></li>
<?php endif; ?>
<?php endif; ?>
