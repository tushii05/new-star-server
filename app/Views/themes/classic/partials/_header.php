...
<link rel="alternate" href="<?= esc(currentFullURL()); ?>" hreflang="<?= $activeLang->language_code; ?>"/>
<?= view('common/_fonts'); ?>
<link href="<?= base_url('assets/vendor/bootstrap-v3/css/bootstrap.min.css'); ?>" rel="stylesheet"/>
<link href="<?= base_url($assetsPath . '/css/style-2.3.min.css'); ?>" rel="stylesheet"/>
<link href="<?= base_url($assetsPath . '/css/plugins-2.3.css'); ?>" rel="stylesheet"/>
<?php if ($darkMode == true) : ?>
<link href="<?= base_url($assetsPath . '/css/dark-2.3.min.css'); ?>" rel="stylesheet"/>
<?php endif; ?>
<?php if ($activeLang->text_direction == "rtl"): ?>
<link href="<?= base_url($assetsPath . '/css/rtl-2.3.min.css'); ?>" rel="stylesheet"/>
