                    ...
                    <div class="row gx-3 widget-follow">
                        <?php foreach ($socialLinks as $socialLink):
                            if (!empty($socialLink['value'])):?>
                                <div class="col-sm-3 col-md-6 item"><a class="color-<?= esc($socialLink['name']); ?>" href="<?= $socialLink['value']; ?>" target="_blank"><i class="icon-<?= esc($socialLink['name']); ?>"></i><span><?= esc($socialLink['text']); ?></span></a></div>
                            <?php endif;
                        endforeach; ?>
                    </div>
                </div>
