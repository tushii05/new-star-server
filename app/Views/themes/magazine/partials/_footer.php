                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 footer-widget footer-widget-about">
                        ...
                        <div class="footer-about">
                          ...
                          <form action="" method="post">
                              <select name="month" onchange="news(this.value);">
                                <?php $rt =get_posts_grouped_by_month();
                                foreach ($rt as $item): 

                                    $date = DateTime::createFromFormat('Y-m', $item->post_month);                               
                                      // Outputs: August 2024
                                    ?>
                                  <option value="<?php echo $date->format('m-Y'); ?>">  <?php echo $date->format('F Y'); ?>                        
                                  </option>
                              <?php endforeach; ?>
                              </select>
                          </form>
...
<script type="text/javascript">
    function news(selectedDate) {
       $.ajax({
            url: '<?= site_url('loadPostsByMonthYear/') ?>' + selectedDate, // Ensure this URL points to the correct CI controller and method
            type: 'GET', 
            dataType: 'html', // Expecting HTML content in return
