                        ...
                        <?php if (!empty($feeds)):
                            foreach ($feeds as $item):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?= base_url('Rss/checkFeedPosts'); ?>" method="post">
                                            <?= csrf_field(); ?>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" onclick="deleteItem('Rss/deleteFeedPost','<?= $item->id; ?>','<?= clrQuotes(trans("confirm_rss")); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
