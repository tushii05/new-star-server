            ...
            <form action="<?= base_url('Admin/generateSitemapPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <?= formRadio('last_modification', 'server_response', 'none', trans("server_response"), trans("none"), $generalSettings->sitemap_last_modification); ?>
                    </div>
                    <div class="form-group">
                        <label class="label-sitemap"><?= trans('priority'); ?></label>
                        <small class="small-sitemap"> (<?= trans('priority_exp'); ?>)</small>
                        <?= formRadio('priority', 'automatically', 'none', trans("priority_none"), trans("none"), $generalSettings->sitemap_priority); ?>
                    </div>
                </div>
