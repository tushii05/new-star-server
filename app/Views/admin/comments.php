                                        ...
                                        <form action="<?= base_url('Admin/approveCommentPost'); ?>" method="post">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    ...
                                                    <?php endif; ?>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="deleteItem('Admin/deleteCommentPost','<?= $item->id; ?>','<?= clrQuotes(trans("confirm_comment")); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </form>
