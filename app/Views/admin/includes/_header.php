...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/css/custom-2.3.css'); ?>">
    ...
    <?php if ($activeLang->text_direction == 'rtl'): ?>
        <link href="<?= base_url('assets/admin/css/rtl-2.3.css'); ?>" rel="stylesheet"/>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li style="display:none;"><a class="btn btn-sm btn-success pull-left btn-site-prev" target="_blank" href="<?= base_url(); ?>"><i class="fa fa-eye"></i> <?= trans("view_site"); ?></a></li>
        ...
        <section class="sidebar">
            ...
            <dv class="sidebar-scrollbar" style="display: block; height: 100%; min-height: 100%;">
                <ul class="sidebar-menu" data-widget="tree" style="padding-bottom: 160px;">
                    ...
                    <?php endif;
                    if (isAdmin()): ?>
                        <li class="nav-themes" style=" display: none;">
                    ...
                    if (checkUserPermission('reward_system')): ?>
                        <li class="treeview<?php isAdminNavActive(['reward-system']); ?>" style=" display: none;">
                    ...
                    <?php endif;
                    if (isAdmin()): ?>
                        <li class="nav-storage" style=" display: none;">
                        ...
                        <li class="nav-google-news">
                            <a href="<?= base_url('admin/add-epapers'); ?>"><i class="fa fa-file"></i><span>E-PAPER</span></a>
                           
                        </li>

                         <li class="nav-google-news">
                            <a href="<?= adminUrl('webstories'); ?>"><i class="fa fa-file"></i><span>Web Story</span></a>
                    ...
                    if (checkUserPermission('settings')): ?>
                        ...
                        <li class="nav-route-settings" style=" display: none;">
