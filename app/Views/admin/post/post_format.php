...
<div class="row">
    <div class="col-sm-12 post-format-container">
        ...
        if ($generalSettings->post_format_table_of_contents == 1):
            ...
            <div class="col-xs-12 col-sm-4 col-lg-3 col-add-post">
                <a href="<?= adminUrl('add-post?type=table_of_contents'); ?>">
                    <div class="item">
                        <div class="item-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#1abc9c" class="bi bi-link-45deg" viewBox="0 0 16 16">
        ...
        if ($generalSettings->post_format_recipe == 1):
            $formatCount += 1; ?>
            <div class="col-xs-12 col-sm-4 col-lg-3 col-add-post" style="display:none;"> 
                <a href="<?= adminUrl('add-post?type=recipe'); ?>">
                    <div class="item">
                        <div class="item-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#1abc9c" viewBox="0 0 64 64">
