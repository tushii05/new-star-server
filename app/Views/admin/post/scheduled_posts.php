                        ...
                        <?php if (!empty($posts)):
                            foreach ($posts as $item):
                                ...
                                <tr>
                                    ...
                                    <td><strong><?= dateDifference(date('Y-m-d'), $item->created_at); ?></strong></td>
                        ...
                        <div class="row">
                            ...
                            <?php if (!empty($posts) && countItems($posts) > 0): ?>
                                <div class="pull-left bulk-options">
                                    ...
                                    <button class="btn btn-sm btn-default btn-table-delete" onclick="postBulkOptions('publish_scheduled');"><i class="fa fa-check option-icon"></i><?= trans('publish'); ?></button>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
