            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="custom-control custom-radio">
                        <input type="radio" name="correct_answer_question_<?= $questionId; ?>" value="<?= $answerUniqueID; ?>" id="radio_answer_<?= $answerUniqueID; ?>" class="custom-control-input">
                        <label for="radio_answer_<?= $answerUniqueID; ?>" class="custom-control-label"><?= trans("correct"); ?></label>
                    </div>
                </div>
            </div>
