            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="custom-control custom-radio">
                        <input type="radio" name="correct_answer_q<?= $answer->question_id; ?>" value="<?= $answer->id; ?>" id="radio_answer_<?= $answer->id; ?>" class="custom-control-input" <?= $answer->is_correct == 1 ? 'checked' : ''; ?>>
                        <label for="radio_answer_<?= $answer->id; ?>" class="custom-control-label"><?= trans("correct"); ?></label>
                    </div>
                </div>
            </div>
