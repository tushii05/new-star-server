        ...
        <form action="<?= base_url('Post/editPostPost'); ?>" method="post" enctype="multipart/form-data" onkeypress="return event.keyCode != 13;">
            ...
            <div class="row">
                <div class="col-sm-12 form-header">
                    <h1 class="form-title"><?= trans('update_audio'); ?></h1>
                    ...
                    <div class="form-post">
                        ...
                        <div class="form-post-right">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <?= view('admin/post/_upload_audio_box'); ?>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <?= view('admin/post/_publish_box', ['postType' => 'audio']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?= view('admin/file-manager/_load_file_manager', ['loadImages' => true, 'loadFiles' => true, 'loadVideos' => false, 'loadAudios' => true]); ?>