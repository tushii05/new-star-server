<div class="box">
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title"><?= trans('image'); ?><span style="color: red;">*</span>
                <small class="small-title"><?= trans('main_post_image'); ?><span style="color: red;">*</span></small>
            </h3>
        </div>
    </div>
    <div class="box-body">
            ...
            <?php if (!empty($post)):
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php endif; ?>
                        <input type="hidden" name="post_image_id" id="post_image_id" required="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
