                                            ...
                                            <td style="width: 180px;">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" onclick="deleteItem('Admin/deleteWidgetPost','<?= $item->id; ?>','<?= clrQuotes(trans("confirm_widget")); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
