...
class CategoryModel extends BaseModel
{
    ...
    public function inputValues()
    {
        $data = [
            ...
            'sub_parent_id' => inputPost('sub_parent_id'),
    ...
    public function addCategory($type)
    {
        ...
        if (!empty($data['sub_parent_id'])) {
           $data['sub_parent_id'] = $data['sub_parent_id'];
        }
    ...
    public function getCityCategoriesByParentId($parentId)
    {
        return $this->builder->where('sub_parent_id', cleanNumber($parentId))->orderBy('name')->get()->getResult();
    }
