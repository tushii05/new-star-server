...
export default function LoginModal({ locale, open, setOpen }) {
    ...
    useFormik({
      ...
      onSubmit: async (value) => {
        ...
        if (result.status === 200) {
          ...
          import("sonner").then((module) => module.toast.error(result.error));
          setLoading(false);
        }
      },
    });
      ...
      <Modal.Body className="modal-body px-4">
        ...
        >
          <div className="col-lg-12 text-center reg-div px-4">
            <h4 className="head mt-0 mb-3">Login</h4>
            ...
            <div className="row d-flex justify-content-center">
              ...
              {errors.password && touched.password ? (
                <div className="text-danger col-lg-12 text-start">
                  {errors.password}
                </div>
              ) : null}
              <div className="col-lg-12 text-end mb-3 mt-2">
                <CustomLink
                  lang={locale}
