...
export default function SmallCardLeft({ post, categoryName, locale }) {
  return (
    <div className="col-lg-6">
      <div className="news-card card-icon-m1">
        <div className="row">
          ...
          <div className="col-lg-6 col-md-6 ps-lg-0 ps-md-0">
            ...
            <p className="news-card-desc mb-2 text-truncate-3">
              {post?.summary}
            </p>
