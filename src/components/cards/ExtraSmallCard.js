...
export default function ExtraSmallCard({
  ...
  const image = post?.image_small || post?.image_mid;
  return (
    <div className={"news-cat-four " + className}>
      <div className={"row mb-3 mx-auto news-6b " + classNameChild}>
        <div className="col-lg-5 col-md-5 col-5 col-sm position-relative">
            ...
            <Image
              ...
              src={checkImage(
                image && image !== "NULL" && image !== null
                  ? getMediaUrl(image, post?.isOld)
                  : post?.image_url
              )}
              alt={post.title ?? "article"}
              className="img-fluid"
              sizes="(max-width : 992px) 146.594px, 100%"
              loading="lazy"
              placeholder="blur"
          ...
          <BookmarkPost width={7} height={14} articleId={post?.id} />
          {checkPostType(post?.post_type, 40, 40)}
        </div>
        <div className="col-lg-7 col-md-7 col-7 col-sm ps-lg-0 ps-md-0">
                ...
                <CustomLink
                  ...
                  href={
                    ...
                    (post?.category?.name_slug ||
                      slugGenerator(categoryName ?? post?.category?.name))
                  }
                >
          ...
          <h4 className="news-card-heading m-0 p-0">
            <CustomLink
          ...
          <p className="news-card-desc mb-0 text-truncate-2">{post?.summary}</p>
        </div>
        <div className="col-lg-12">
          <div className="row news-date-time mt-2 d-flex align-items-center">
            <div className="col-7 col-md-6 d-flex pe-1">
              <p className="mb-0 me-3 me-md-2" style={{ display: "inherit" }}>
                By:&nbsp;
                <CustomLink
            ...
            <div className="col-5 col-md-6 ps-1 d-flex justify-content-end">
              <p className="mb-0">
