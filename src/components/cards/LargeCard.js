...
export default function LargeCard({ post, categoryName, locale }) {
  return (
    <div
      className="col-lg-6 col-md-6 ps-lg-1 ps-md-1 pe-lg-3 pe-md-3"
    ...
    >
      <div className="news-card card-icon-m1">
        ...
        <BookmarkPost articleId={post?.id} />
        ...
        <p className="news-card-desc mb-2 text-truncate-3">{post?.summary}</p>
